...
function showTechInfo(e){
	...
	switch(selectedIcon) {
		...
		case "onepassword":
				...
				techDescription.textContent = "1Password is used to allow our teams access to various softwares."
		...
		case "css3":
				...
				techDescription.textContent = "The latest version of CSS enables us to create really awesome style effects. These scrolling icons are 100% CSS3 for example."
		...
		case "bubble":
				...
				techDescription.textContent = "For MVPs, prototyping and even powerful applications."
		...
		case "figma":
				...
				techDescription.textContent = "Our wireframes and prototypes are all created in Figma. Our clients are given remote access so they can view the design creation in realtime."
		...
		case "canva":
				...
				techDescription.textContent = "For marketing materials and client branding."
		...
		case "github":
				...
				techImage.src = "https://uploads-ssl.webflow.com/6359366be98d64842004c4dd/63692f8e1fb2856e4c2bfc4b_dribbble.png"
				break;
		case "googlefonts":
		...
		case "html5":
				...
				techDescription.textContent = "We use semantic HTML for great sites."
		...
		case "illustrator":
				...
				techDescription.textContent = "We use illustrator in our design process and to integrate vector graphics into our builds."
		...
		case "loom":
				...
				techDescription.textContent = "We use loom for quick and efficient communication as welll as onboarding."
		...
		case "mailchimp":
				...
				techDescription.textContent = "To integrate marketing automations for our client builds."
		...
		case "indesign":
				...
				techDescription.textContent = "We use In Design as part of our graphic design suite of tools. Particularly for clients who request branding services."
		...
		case "react":
				...
				techDescription.textContent = "We can integrate react components into Webflow as well as use Webflow in React apps."
		...
		case "typescript":
			...
			techDescription.textContent = "Because even JavaScript needs some sugar."
		...
		default:
			techName.textContent = "Hover over any icon..."
			techDescription.textContent = "...to see how we use the tech in our stack."
		}
